      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mb-32">
          ...
          <ScrollReveal animation="fade-right" delay={300}>
            <div className="flex items-center space-x-6">
              ...
              <p className="text-gray-400 uppercase tracking-[0.5em] text-[11px] font-black">Trusted Canadian Excellence</p>
            </div>
          </ScrollReveal>
        </div>
        ...
        <div className="mb-40">
          <ScrollReveal animation="fade-up">
            <div className="glass-light p-12 rounded-[40px] space-y-8 border-white/50 shadow-sm">
              <h2 className="text-5xl font-display tracking-tighter text-white">OUR <span className="text-red-600">PROMISE</span></h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="flex items-start space-x-4">
                  <div className="w-6 h-6 rounded-full bg-red-600 flex items-center justify-center mt-1 flex-shrink-0">
                    <i className="fa-solid fa-check text-white text-xs"></i>
                  </div>
                  <div>
                    <h3 className="font-display text-xl text-white mb-2">Quality Materials</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-display text-xl text-white mb-2">Skilled Professionals</h3>
                    <p className="text-gray-300 font-medium leading-relaxed">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-display text-xl text-white mb-2">On-Time Delivery</h3>
                    <p className="text-gray-300 font-medium leading-relaxed">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-display text-xl text-white mb-2">Transparent Communication</h3>
                    <p className="text-gray-300 font-medium leading-relaxed">
                ...
                <div className="flex items-start space-x-4 md:col-span-2">
                  ...
                  <div>
                    <h3 className="font-display text-xl text-white mb-2">Customer Satisfaction</h3>
                    <p className="text-gray-300 font-medium leading-relaxed">
        ...
        <div className="grid lg:grid-cols-2 gap-24 mb-40 items-center">
          <div className="space-y-12">
            <ScrollReveal animation="fade-up">
              <div className="glass-light p-12 rounded-[40px] space-y-8 border-white/50 shadow-sm">
                <h2 className="text-5xl font-display tracking-tighter text-white">WHO <span className="text-red-600">WE ARE</span></h2>
                
                <div className="space-y-8">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 rounded-lg bg-red-50 text-red-600 flex items-center justify-center text-xl font-bold flex-shrink-0">01</div>
                    <div>
                      <h3 className="font-display text-2xl text-white mb-2">Trusted Canadian Expertise</h3>
                      <p className="text-gray-300 font-medium leading-relaxed">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 rounded-lg bg-red-50 text-red-600 flex items-center justify-center text-xl font-bold flex-shrink-0">02</div>
                    <div>
                      <h3 className="font-display text-2xl text-white mb-2">Strong Core Values</h3>
                      <p className="text-gray-300 font-medium leading-relaxed">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 rounded-lg bg-red-50 text-red-600 flex items-center justify-center text-xl font-bold flex-shrink-0">03</div>
                    <div>
                      <h3 className="font-display text-2xl text-white mb-2">Comprehensive Experience</h3>
                      <p className="text-gray-300 font-medium leading-relaxed">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 rounded-lg bg-red-50 text-red-600 flex items-center justify-center text-xl font-bold flex-shrink-0">04</div>
                    <div>
                      <h3 className="font-display text-2xl text-white mb-2">Passionate Professionals</h3>
                      <p className="text-gray-300 font-medium leading-relaxed">
