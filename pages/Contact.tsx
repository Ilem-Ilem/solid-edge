        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto space-y-12 glass-light p-20 rounded-[64px] border-white shadow-2xl">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl font-display tracking-tight text-slate-900 uppercase">Message <span className="text-blue-600">Sent</span></h1>
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mb-32">
          ...
          <div className="flex items-center space-x-6">
            ...
            <p className="text-slate-400 uppercase tracking-[0.5em] text-[11px] font-black">WE'D LOVE TO HEAR FROM YOU</p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-24">
          <div className="space-y-12">
            <div className="glass-light p-10 rounded-[40px] space-y-8 border-white/50 shadow-sm">
              <h2 className="text-4xl font-display tracking-tighter text-slate-900">CONTACT <span className="text-blue-600">INFORMATION</span></h2>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h3 className="font-black text-[11px] uppercase tracking-[0.2em] text-slate-900 mb-2">ADDRESS</h3>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h3 className="font-black text-[11px] uppercase tracking-[0.2em] text-slate-900 mb-2">PHONE</h3>
                    <p className="text-slate-500 font-medium leading-relaxed">
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h3 className="font-black text-[11px] uppercase tracking-[0.2em] text-slate-900 mb-2">WHATSAPP</h3>
                    <p className="text-slate-500 font-medium leading-relaxed">
          ...
          <div className="glass-light p-10 md:p-16 rounded-[64px] relative z-10 border-white shadow-2xl">
            <h2 className="text-4xl font-display tracking-tighter text-slate-900 mb-8">SEND US A <span className="text-blue-600">MESSAGE</span></h2>

            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="block text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 ml-1">Your Name</label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div className="space-y-3">
                  <label className="block text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 ml-1">Email Address</label>
                  <input
                    type="email"
                    name="email"
              ...
              <div className="space-y-3">
                <label className="block text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 ml-1">Subject</label>
                <input
                  type="text"
                  name="subject"
              ...
              <div className="space-y-3">
                <label className="block text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 ml-1">Message</label>
                <textarea
                  name="message"
